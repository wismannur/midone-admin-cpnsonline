    ...
    <client-only>
      ...
      <div class="mobile-menu md:hidden">
        <div class="mobile-menu-bar">
          ...
          <a id="mobile-menu-toggler" href="javascript:;">
            <i
        ...
        <ul class="border-t border-theme-24 py-5 hidden">
          ...
          <li>
            <a href="javascript:;" class="menu" @click="callSideMenu()">
                  ...
                  <div class="cursor-pointer relative flex items-center mt-5">
                    ...
                    <div class="ml-2 overflow-hidden">
                      ...
                      <div class="w-full truncate text-gray-600 mt-0.5">
                        ...
                        racted by the readable content of a page when looking at
                ...
                >
                  ...
                  <div class="p-2">
                    ...
                    <a
                      ...
                      class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md"
                    >
                      <i data-feather="edit" class="w-4 h-4 mr-2"></i> Add
                      Account
                    </a>
                    <a
                      href=""
              ...
              <div class="col-span-12 xl:col-span-8 mt-6">
                ...
                <div class="intro-y box p-5 mt-12 sm:mt-5">
                  ...
                  <div
                    ...
                    data-sources="//json/location.json"
                  ></div>
                </div>
              </div>
              <!-- END: Official Store -->
              ...
              <div class="col-span-12 grid grid-cols-12 gap-6 mt-8">
                ...
                <div class="col-span-12 sm:col-span-6 xxl:col-span-3 intro-y">
                  <div class="mini-report-chart box p-5 zoom-in">
                    ...
                    <div class="mt-4">
                      <canvas
                        class="simple-line-chart-1 -ml-1"
                        height="60"
                      ></canvas>
                    </div>
                  </div>
                ...
                >
                  ...
                  <div class="mt-5 intro-x">
                    <div class="box zoom-in">
                      <div id="important-notes" class="tiny-slider">
                        <div class="p-5">
                    ...
                    <div class="intro-x box">
                      <div class="p-5">
                        ...
                        <div class="grid grid-cols-7 gap-4 mt-5 text-center">
                          ...
                          <div class="py-1 rounded relative text-gray-600">
                            29
                          </div>
                          <div class="py-1 rounded relative text-gray-600">
                            30
                      ...
                      <div class="border-t border-gray-200 p-5">
                        ...
                        <div class="flex items-center mt-4">
                          ...
                          ></div>
                          <span class="truncate"
                            >VueJs Frontend Development</span
                          >
                          <div
                            class="h-px flex-1 border border-r border-dashed border-gray-300 mx-3 xl:hidden"
                          ></div>
  ...
  methods: {
    callSideMenu() {
      $('.side-menu').on('click', e => {
        console.log('e side-menu ', e)
        // e.parent().find('ul').length &&
        //   (null !== e.parent().find('ul').first()[0].offsetParent
        //     ? (e
        //         .find('.side-menu__sub-icon')
        //         .removeClass('transform rotate-180'),
        //       e.removeClass('side-menu--open'),
        //       (e.parent().find('ul').first(),
        //       'slideUp',
        //       {
        //         duration: 300,
        //         complete: function (t) {
        //           t.removeClass('side-menu__sub-open')
        //         },
        //       }))
        //     : (e.find('.side-menu__sub-icon').addClass('transform rotate-180'),
        //       e.addClass('side-menu--open'),
        //       (e.parent().find('ul').first(),
        //       'slideDown',
        //       {
        //         duration: 300,
        //         complete: function (t) {
        //           t.addClass('side-menu__sub-open')
        //         },
        //       })))
      })
    },
